...
public interface FedoraRepository {
    ...
    **/
     ...
     * Create a new Object.
     * @param path The Object path.
     * @param isIdAutogen Whether the identifier should autogenerated or not.
    **/
    public FedoraObject createObject( String path, boolean isIdAutogen ) throws FedoraException;
